...
const AppSettingsSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'LastPopupShownDate': PropertySchema(
      id: 1,
      name: r'LastPopupShownDate',
      type: IsarType.dateTime,
    )
  },
...
void _appSettingsSerialize(
  ...
  writer.writeDateTime(offsets[1], object.LastPopupShownDate);
}
...
AppSettings _appSettingsDeserialize(
  ...
  object.LastPopupShownDate = reader.readDateTimeOrNull(offsets[1]);
  object.id = id;
  return object;
}
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      lastPopupShownDateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'LastPopupShownDate',
      ));
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      lastPopupShownDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'LastPopupShownDate',
      ));
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      lastPopupShownDateEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'LastPopupShownDate',
        value: value,
...
extension AppSettingsQuerySortBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy>
      sortByLastPopupShownDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'LastPopupShownDate', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy>
      sortByLastPopupShownDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'LastPopupShownDate', Sort.desc);
    });
  }
}
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct>
      distinctByLastPopupShownDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'LastPopupShownDate');
    });
  }
}
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, DateTime?, QQueryOperations>
      LastPopupShownDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'LastPopupShownDate');
    });
  }
}
